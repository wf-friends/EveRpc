 ...
 */
public class ConnectZKManage {

    private static final Logger LOGGER = LoggerFactory.getLogger(ConnectZKManage.class);
    private volatile static ConnectZKManage connectManage;
    ...
    private ConnectZKManage() {
    }

    public static ConnectZKManage getInstance() {
        if (connectManage == null) {
            synchronized (ConnectZKManage.class) {
                if (connectManage == null) {
                    connectManage = new ConnectZKManage();
                }
            }
        }
